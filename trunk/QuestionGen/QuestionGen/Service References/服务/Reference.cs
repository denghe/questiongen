...
namespace QuestionGen.服务 {
    ...
    public partial class 类型_获取CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public 类型_获取CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class 题Client : System.ServiceModel.ClientBase<QuestionGen.服务.题>, QuestionGen.服务.题 {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] QuestionGen.服务.题.End类型_获取(System.IAsyncResult result) {
            return base.Channel.End类型_获取(result);
        }
        
        private System.IAsyncResult OnBegin类型_获取(object[] inValues, System.AsyncCallback callback, object asyncState) {
            byte[] 查询 = ((byte[])(inValues[0]));
            return ((QuestionGen.服务.题)(this)).Begin类型_获取(查询, callback, asyncState);
        }
        
        private object[] OnEnd类型_获取(System.IAsyncResult result) {
            byte[] retVal = ((QuestionGen.服务.题)(this)).End类型_获取(result);
            return new object[] {
                    retVal};
        }
        
        private void On类型_获取Completed(object state) {
            if ((this.类型_获取Completed != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.类型_获取Completed(this, new 类型_获取CompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void 类型_获取Async(byte[] 查询) {
            this.类型_获取Async(查询, null);
        }
        
        public void 类型_获取Async(byte[] 查询, object userState) {
            if ((this.onBegin类型_获取Delegate == null)) {
                this.onBegin类型_获取Delegate = new BeginOperationDelegate(this.OnBegin类型_获取);
            }
            if ((this.onEnd类型_获取Delegate == null)) {
                this.onEnd类型_获取Delegate = new EndOperationDelegate(this.OnEnd类型_获取);
            }
            if ((this.on类型_获取CompletedDelegate == null)) {
                this.on类型_获取CompletedDelegate = new System.Threading.SendOrPostCallback(this.On类型_获取Completed);
            }
            base.InvokeAsync(this.onBegin类型_获取Delegate, new object[] {
        ...
        private class 题ClientChannel : ChannelBase<QuestionGen.服务.题>, QuestionGen.服务.题 {
            ...
            public System.IAsyncResult Begin类型_获取(byte[] 查询, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = 查询;
                System.IAsyncResult _result = base.BeginInvoke("类型_获取", _args, callback, asyncState);
                return _result;
            }
